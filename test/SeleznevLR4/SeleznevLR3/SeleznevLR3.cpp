...
// SeleznevLR3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSeleznevLR3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSeleznevLR3App::OnAppAbout)
...
// Создание CSeleznevLR3App

CSeleznevLR3App::CSeleznevLR3App() noexcept
{
...
#endif
	SetAppID(_T("SeleznevLR3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSeleznevLR3App

CSeleznevLR3App theApp;


// Инициализация CSeleznevLR3App

BOOL CSeleznevLR3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSeleznevLR3Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSeleznevLR3View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CSeleznevLR3App
...
void CSeleznevLR3App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
